...
name: searchlib
agent: ask
description: AI Agent assisting developers in finding libraries for specific tasks to save time
---
...
5. Use the Project Context and reading tools to analyze the project and see which library matches.
